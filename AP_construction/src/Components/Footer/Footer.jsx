...
const Footer = () => {
    ...
    const translations = {
        English: {
            description: "Creating harmonious spaces with Vedic principles. Vastushobha Construction blends traditional wisdom with modern techniques to build homes that nurture and inspire.",
            ...
            copyright: `© ${new Date().getFullYear()} Vastushobha Construction. All rights reserved.`,
            policies: ["Privacy Policy", "Terms of Service", "Sitemap"],
            hours: "Mon-Sat: 9:00 AM - 6:00 PM"
        },
        Hindi: {
            description: "वैदिक सिद्धांतों के साथ सामंजस्यपूर्ण स्थान बनाना। वास्तुशोभा कंस्ट्रक्शन पारंपरिक ज्ञान को आधुनिक तकनीकों के साथ जोड़कर ऐसे घर बनाता है जो पोषण करते हैं और प्रेरित करते हैं।",
            ...
            links: [
                ...
                { name: "वास्तु ब्लॉग", path: "/blog" },
                { name: "संपर्क करें", path: "/contact" },
                { name: "करियर", path: "/careers" }
            ],
            contactTitle: "हमसे संपर्क करें",
            copyright: `© ${new Date().getFullYear()} वास्तुशोभा कंस्ट्रक्शन। सर्वाधिकार सुरक्षित।`,
            policies: ["गोपनीयता नीति", "सेवा की शर्तें", "साइटमैप"],
            hours: "सोम-शनि: सुबह 9:00 - शाम 6:00"
        },
        Marathi: {
            description: "वैदिक तत्त्वांसह सुसंवादी जागा तयार करणे. वास्तुशोभा कंस्ट्रक्शन पारंपारिक ज्ञान आणि आधुनिक तंत्रज्ञान एकत्रित करून अशा घरांची निर्मिती करते जी पोषण करतात आणि प्रेरणा देतात.",
            ...
            copyright: `© ${new Date().getFullYear()} वास्तुशोभा कंस्ट्रक्शन. सर्व हक्क राखीव.`,
                        ...
                        <div className="absolute top-12 right-0 bg-gray-800 rounded-lg shadow-lg z-10 w-40 overflow-hidden">
                            {['English', 'Hindi', 'Marathi'].map((lang) => (
                                <button
                                    ...
                                    className={`w-full text-left px-4 py-2 hover:bg-gray-700 transition-colors ${language === lang ? 'bg-red-600 text-white' : 'text-gray-200'}`}
                                >
                                    {lang}
                                </button>
                            ))}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center space-x-3 mb-6">
                            <div className="w-12 h-12 rounded-lg flex items-center justify-center bg-gradient-to-br from-red-600 to-red-800 p-2 shadow-md">
                                <img 
                        ...
                        <div className="flex space-x-4">
                            <a href="#" 
                               ...
                               aria-label="LinkedIn">
                                <Linkedin className="w-5 h-5 text-red-500 hover:text-red-400" />
                            </a>
                            <a href="#" 
                               className="hover:scale-110 transition-all bg-gray-800 p-2 rounded-full shadow-sm hover:shadow-md hover:bg-gray-700" 
                               aria-label="Instagram">
                                <Instagram className="w-5 h-5 text-red-500 hover:text-red-400" />
                            </a>
                            <a href="#" 
                               className="hover:scale-110 transition-all bg-gray-800 p-2 rounded-full shadow-sm hover:shadow-md hover:bg-gray-700" 
                               aria-label="WhatsApp">
                                <svg className="w-5 h-5 text-red-500 hover:text-red-400" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            {t.services.map((service) => (
                                <li key={service}>
                                    <a href="#" className="text-gray-300 hover:text-white transition-colors flex items-center group">
                                        <span className="w-2 h-2 bg-red-500 rounded-full mr-3 group-hover:scale-150 transition-transform"></span>
                                        {service}
                                    </a>
                                </li>
                            ))}
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="space-y-3">
                                {[
                                    ...
                                    { icon: <Mail size={16} />, text: "contact@vastushobha.com", href: "mailto:contact@ap.com" }
                                ].map((contact, index) => (
                                    <a key={index} href={contact.href} className="flex items-center group">
                                        <div className="bg-gray-800 p-2 rounded-full mr-3 group-hover:bg-gray-700 transition-colors shadow-sm">
                                            {React.cloneElement(contact.icon, { className: "text-red-500 group-hover:text-red-400" })}
                                        </div>
